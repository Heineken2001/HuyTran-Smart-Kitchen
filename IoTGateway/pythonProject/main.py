...
AIO_FEED_IDS = ["do-an-da-nganh.co3109-dht11-temp", "do-an-da-nganh.co3109-dht11-humid",
                "do-an-da-nganh.co3109-gas-sensor", "do-an-da-nganh.co3109-infrared-sensor",
                "do-an-da-nganh.co3109-2-color-led", "do-an-da-nganh.co3109-buzzer",
                "do-an-da-nganh.co3109-gas-threshold", "do-an-da-nganh.co3109-manual-led"]
AIO_USERNAME = "nhungcoder_codon"
AIO_KEY = "aio_DTiY04021PVfww6LzPtVDlterYMy"
...
def  message(client , feed_id , payload):
    if feed_id == AIO_FEED_IDS[0]:
        ...
        print("Nhan du lieu nguong khi gas: " + payload)
        ser.write((str(payload) + "#").encode())
    elif feed_id == AIO_FEED_IDS[7]:
        print("Nhan du lieu den tu dong: " + payload)
        ser.write((str(payload) + "#").encode())
