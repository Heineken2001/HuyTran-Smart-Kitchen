var Dial = function(container_temp) {
    ...
    this.value = this.container_temp.dataset.value;
    this.direction = this.container_temp.dataset.arrow;
    this.svg;
    this.defs;
    this.slice;
    this.overlay;
...
Dial.prototype.create = function() {
    ...
    this.createText();
    this.createArrow();
    this.container_temp.appendChild(this.svg);
};
...
Dial.prototype.createText = function() {
    ...
    text.innerHTML = 0 + '<tspan font-size="' + tspanSize + '" dy="' + -tspanSize * 1.2 + '">°C</tspan>';
