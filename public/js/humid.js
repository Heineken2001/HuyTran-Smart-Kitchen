var Dial = function(container_humid) {
    this.container_humid = container_humid;
    this.size = this.container_humid.dataset.size;
    this.strokeWidth = this.size / 12;
    this.radius = (this.size / 2) - (this.strokeWidth / 2);
    this.value = this.container_humid.dataset.value;
    this.direction = this.container_humid.dataset.arrow;
    this.svg;
    this.defs;
    this.slice;
    this.overlay;
...
Dial.prototype.create = function() {
    ...
    this.createText();
    this.createArrow();
    this.container_humid.appendChild(this.svg);
};
...
var containers = document.getElementsByClassName("chart_humid");
