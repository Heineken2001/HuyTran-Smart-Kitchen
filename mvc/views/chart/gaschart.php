        ...
        <div class="grid">
            ...
            <div id="row1" class="row" style="display:flex">
                ...
                <div class="col l-5 m-5 c-12 room__status__body__list" style="border-radius: 20px;">
                    ...
                    <h5 id="gasdate" style="text-align: left; color: black; margin: 40px auto auto 40px; line-height: 22px">Nồng độ gas trung bình trong ngày <?php echo date("d-m-Y", time()+7*60*60);?> là: <?php echo $gas_data_all ?>ppm.
                    ...
                    <h5 id="gasmonth" style="text-align: left; color: black; margin: 40px auto auto 40px; line-height: 22px" hidden>Nồng độ gas trung bình trong tháng <?php echo date("m-Y", time()+7*60*60);?> là: <?php echo $gas_data_all_month ?>ppm.
