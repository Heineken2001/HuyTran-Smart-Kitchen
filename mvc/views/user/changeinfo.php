<div class="row account__manage__body">
            ...
            <div class="grid" style="display: flex; flex-direction: column; ">
                <form action="<?php echo BASE_URL ?>/user/updateinfo/<?php echo $_SESSION['userid']?>" method="post" id="updateform" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col l-8 m-8 c-12" style="background-color:rgba(201,208,215,0.6); background-clip:content-box; padding:0 32px 0 32px;">
                                ...
                                <div class="account__info">Image: <input type="file" class="form__field" name="image"/></div>
