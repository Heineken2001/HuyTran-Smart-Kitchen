<?php
    class lightswitch extends Controller {
        ...
        public function switch()
        {
            ...
            $url = "https://io.adafruit.com/api/v2/nhungcoder_codon/feeds/do-an-da-nganh.co3109-2-color-led/data";
        ...
        public function mode()
        {
            ...
            $url = "https://io.adafruit.com/api/v2/nhungcoder_codon/feeds/do-an-da-nganh.co3109-manual-led/data";
